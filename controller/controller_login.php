...
if (empty($_POST['btnLogin'])) {
    if (!empty($_POST['usuario']) && !empty($_POST['password'])) {
        ...
        $sql = $conn -> query("select u.id_usuario, e.nombre_empleado, e.apellido_empleado, u.usuario, u.password from empleados e inner join usuarios u on e.id_usuario = u.id_usuario WHERE usuario = '$usuario' AND password = '$password';");
